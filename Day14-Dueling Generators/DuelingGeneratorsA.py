...
class DuelingGenerator():
    ...
    def calculate(self, old_value):
        return (old_value * self.factor) % self.divisor
...
generator_a = DuelingGenerator(GENERATOR_A_FACTOR)
generator_b = DuelingGenerator(GENERATOR_B_FACTOR)
